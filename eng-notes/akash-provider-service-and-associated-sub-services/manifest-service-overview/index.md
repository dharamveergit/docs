...
* [Receipt of Manifest from Tenant Send to Provider](/docs/eng-notes/akash-provider-service-and-associated-sub-services/manifest-service#5-receipt-of-manifest-from-tenant-send-to-provider)